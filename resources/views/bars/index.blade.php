                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @can('haveaccess','bars.show')
                                    <a href="{{route('bars.show',['bar'=>$bar] )}}" class="btn btn-info"><svg
                                    ...
                                    @endcan
                                    @can('haveaccess','bars.edit')
                                    <a href="{{route('bars.edit',['bar'=>$bar] )}}" class="btn btn-primary"><svg
