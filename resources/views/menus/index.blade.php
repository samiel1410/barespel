                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    @endcan
                                    @can('haveaccess','menus.edit')
                                    <a href="{{route('menus.edit',['menu'=>$menu] )}}" class="btn btn-primary"><svg
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="24"
                                            height="24">
                                            <path fill-rule="evenodd"
